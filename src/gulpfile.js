...
function modules() {
  // Bootstrap JS
  var bootstrapJS = gulp.src('./assets/node_modules/bootstrap/dist/js/*')
    .pipe(gulp.dest('./assets/vendor/bootstrap/js'));
  // Bootstrap SCSS
  var bootstrapSCSS = gulp.src('./assets/node_modules/bootstrap/scss/**/*')
    .pipe(gulp.dest('./assets/vendor/bootstrap/scss'));
  // ChartJS
  var chartJS = gulp.src('./assets/node_modules/chart.js/dist/*.js')
